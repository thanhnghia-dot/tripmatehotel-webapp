...
public class HotelReviewController {
    ...
    public ResponseEntity<List<HotelReview>> getMyReviews(@PathVariable Long hotelId) {
        String email = ((UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUsername();
        List<HotelReview> reviews = hotelReviewService.getMyReviewsByHotel(hotelId, email);
