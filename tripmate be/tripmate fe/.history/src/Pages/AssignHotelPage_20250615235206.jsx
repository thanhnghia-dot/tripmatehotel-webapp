                  ...
                  <div className={`card h-100 ${isSelected ? 'border-success shadow' : ''}`}>
                    ...
                    <div className="card-body">
                      <label style={{ cursor: 'pointer' }}>
                        ...
                        {room.description3 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description3}</p>}
                        {room.description4 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description4}</p>}
                        {room.description5 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description5}</p>}
                        {room.description6 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description6}</p>}
                        {room.description7 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description7}</p>}
                        {room.description8 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description8}</p>}
                        {room.description9 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description9}</p>}
                        {room.description10 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description10}</p>}
                        {room.description11 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description11}</p>}
                        {room.description12 && <p className="mt-2"  style={{fontSize: 16, fontWeight: 400}}>-{room.description12}</p>}
                      </label>
