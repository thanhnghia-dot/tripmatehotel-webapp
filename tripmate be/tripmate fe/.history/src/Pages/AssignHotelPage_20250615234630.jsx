                    ...
                    <div className="card-body">
                      <label style={{ cursor: 'pointer' }}>
                        ...
                        <div className="mt-2"></div>
                          <span className="text-danger" style={{ fontSize: '1.2em', fontWeight: 'bold' }}>
                            ${room.pricePerNight.toFixed(2)}
                            {room.discount > 0 && (
                              <span className="text-decoration-line-through ms-2" style={{ color: '#6c757d' }}>
                                ${((room.pricePerNight ?? 0) * (1 - (room.discount ?? 0) / 100))?.toFixed(2)}
                              </span>
                            )}
                          </span>
