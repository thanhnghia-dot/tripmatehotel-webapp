                  ...
                  <div className={`card h-100 ${isSelected ? 'border-success shadow' : ''}`}>
                    ...
                    <div className="card-body">
                      <label style={{ cursor: 'pointer' }}>
                        ...
                        {/* Price: room.pricePerNight & discount percent: room.discount */}
                        <p className="mt-2">
                          <strong>Price:</strong> {room.pricePerNight.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })} / night
                          {room.discount > 0 && (
                            <span className="text-success ms-2">
                              <strong>Discount:</strong> {room.discount}% off
                            </span>
                          )}
                        </p>
                        {room.description2 && <p className="mt-2">{room.description2}</p>}
