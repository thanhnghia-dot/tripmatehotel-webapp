        ...
        <div style={{ marginTop: 24 }}>
          ...
          <button
            ...
            onClick={async () => {
              ...
              try {
                const token = localStorage.getItem("token");
                await axios.post(`http://localhost:8080/api/hotels/${trip.hotel.id}/reviews`, review, {
                  headers: { Authorization: `Bearer ${token}` }
                });
                ...
                // Refresh review list
                const res = await axios.get(`http://localhost:8080/api/hotels/${trip.hotel.id}/reviews`);
                setReviews(res.data);
              } catch (err) {
          ...
          <div style={{ marginTop: 24 }}>
            <h5>Đánh giá từ người dùng khác</h5>
            {reviews.length === 0 ? (
